...
<head>
    ...
    <style>
        ...
        .card .card-statistic-3 .card-icon-large fa-sharp,
...
<body>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-cherry">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Total Surveys</h5>
                            </div>
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Average Age</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-green-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Oldest Person</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-3 col-lg-7">
                    <div class="card l-bg-orange-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Youngest Person</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
    ...
    <div class="container mt- d-flex justify-content-center">
        <div class="col-md-10 ">
            <div class="row ">
                <div class="col-xl-3 col-lg-9">
                    <div class="card l-bg-cherry">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Percentage of people who like Pizza </h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            <div class="card-icon card-icon-large"><i class="fas fa-bacon"></i></div>
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Percentage of people who like Pasta</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-green-dark">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">Percentage of people who like Pap and Wors</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
        ...
        <div class="col-md-10 ">
            <div class="row ">
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-cherry">
                        <div class="card-statistic-3 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="card-title mb-0">People like to eat out:</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-blue-dark">
                        <div class="card-statistic-3 p-4">
                            <div class="card-icon card-icon-large"><i class="fas fa-film fa-beat"></i></i></div>
                            <div class="mb-4">
                                <h5 class="card-title mb-0">People like to watch movies:</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-green-dark">
                        <div class="card-statistic-3 p-4">
                            <div class="card-icon card-icon-large"><i class="fas fa-television"></i></div>
                            <div class="mb-4">
                                <h5 class="card-title mb-0">People like to watch TV:</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-3 col-lg-6">
                    <div class="card l-bg-orange-dark">
                        <div class="card-statistic-3 p-4">
                            <div class="card-icon card-icon-large"><i class="fas fa-radio"></i></div>
                            <div class="mb-4">
                                <h5 class="card-title mb-0">People like to listen to the radio
                                    <div class="row align-items-center mb-2 d-flex">
                                        <div class="col-8">
                                            <h2 class="d-flex align-items-center mb-0">
                                                <?php echo $radio ?>
    ...
    <div class="container mb-1 d-flex justify-content-center" style="padding-bottom: 5;">
        <div class="col-md-5 ">
            <div class="row">
                <a href="../Survey-system/index.html" class="btn btn-secondary"> OK </a>
            </div>
        </div>
    </div>
    <footer>
